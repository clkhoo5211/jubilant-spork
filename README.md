...
> 💡 **Tip**: For testing, you can use Binance Testnet by setting `"binance_testnet": true` and using testnet API keys from [testnet.binancefuture.com](https://testnet.binancefuture.com). This lets you test without real funds!
...
|------------|--------------|--------------|
| `YOUR_BINANCE_API_KEY` | Your Binance API Key | Binance → Account → API Management<br>Or [Testnet](https://testnet.binancefuture.com) for testing |
...
| `binance_testnet` | Use Binance testnet | `true` or `false` | ❌ No (defaults to false) |
